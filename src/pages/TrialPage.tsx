      ...
      {stage === 'success' && credentials && (
        <div className="flex flex-col gap-6">
          ...
          <p className="text-sm text-gray-500 text-center">
            Your dashboard has full setup instructions for <strong>OpenVPN</strong>, <strong>IKEv2</strong>, <strong>L2TP</strong>, <strong>Stealth</strong> (for Russia), and <strong>WireGuard</strong>.
          </p>
